...
<div class="row logo-menu-container">
    <div class="hidden-xs hidden-sm col-md-12 col-lg-12 header-block">
        ...
        ('home');">Russ Etheridge</span><div class="contact-email"><a href="mailto:contact@russetheridge.com">contact@russetheridge.com</a></div>
            <div class=""><a target="_blank" href="https://www.instagram.com/russ_ether/"><img class="contact-social" src="{{config('app.base_url')}}img/social/instagram.png?v1" title="Share on Instagram" alt="" /></a><a target="_blank" href="https://www.linkedin.com/in/russether"><img class="contact-social" src="{{config('app.base_url')}}img/social/linkedin.png?v1" title="Share on linkedin" alt="" /></a><a target="_blank" href="https://twitter.com/russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/twitter.png?v1" title="Share on twitter" alt="" /></a><a target="_blank" href="https://youtube.com/@russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/youtube.png?v1" title="" alt="Check out my Channel" /></a></div>
        </div>
    ...
    <div class="hidden-xs col-sm-12 hidden-md hidden-lg header-block">
        <div class="contact-social-medium"><div class="contact-email"><a href="mailto:contact@russetheridge.com">contact@russetheridge.com</a></div>
            <div class=""><a target="_blank" href="https://www.instagram.com/russ_ether/"><img class="contact-social" src="{{config('app.base_url')}}img/social/instagram.png?v1" title="Share on Instagram" alt="" /></a><a target="_blank" href="https://www.linkedin.com/in/russether"><img class="contact-social" src="{{config('app.base_url')}}img/social/linkedin.png?v1" title="Share on linkedin" alt="" /></a><a target="_blank" href="https://twitter.com/russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/twitter.png?v1" title="Share on twitter" alt="" /></a><a target="_blank" href="https://youtube.com/@russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/youtube.png?v1" title="" alt="Check out my Channel" /></a></div></div>
    </div>
    ...
    <div class="col-xs-12 hidden-sm hidden-md hidden-lg sub-header-block"><span class="filter-label">Filter:</span>
        <table class="logo-menu-table">
            ...
            <tr>
                <td class="" colspan="5">
                    <div class="contact-social-small"><div class="contact-email"><a href="mailto:contact@russetheridge.com">contact@russetheridge.com</a></div>
                        <div class="contact-socials"><a target="_blank" href="https://www.instagram.com/russ_ether/"><img class="contact-social" src="{{config('app.base_url')}}img/social/instagram.png?v1" title="Share on Instagram" alt="" /></a><a target="_blank" href="https://www.linkedin.com/in/russether"><img class="contact-social" src="{{config('app.base_url')}}img/social/linkedin.png?v1" title="Share on linkedin" alt="" /></a><a target="_blank" href="https://twitter.com/russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/twitter.png?v1" title="Share on twitter" alt="" /></a><a target="_blank" href="https://youtube.com/@russ_ether"><img class="contact-social" src="{{config('app.base_url')}}img/social/youtube.png?v1" title="" alt="Check out my Channel" /></a></div></div>
                </td>
            </tr>
            </tbody>
        </table>
